...
class ASADataProcessor:
    ...
    def fetch_data(self, competition):
        ...
        try:
            ...
            # Fetch basic dimension (DIM) tables with error handling
            try:
            ...
            # Merge team statistics and convert data types
            ...
            teams = teams[[self.TEAM_ID, 'team_name', 'team_short_name', 'team_abbreviation', 'competition', 'minutes', 'data',
            ...
            # Fetch stadium, managers, and referees data with error handling
            try:
            ...
            # Process goalkeeper specific FACT tables with error handling
            try:
            ...
            # Merge goalkeeper specific data with goalkeepers DataFrame
            ...
            try:
                games['match_name'] = games['team_abbreviation_home'].astype(str) + "v" + games['team_abbreviation_away'].astype(str)
